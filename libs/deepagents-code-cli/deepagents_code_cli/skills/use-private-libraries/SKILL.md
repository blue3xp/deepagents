---
name: use-private-libraries
description: Instructions for using internal private libraries instead of standard alternatives.
---

# Skill: Use Private Libraries

## Description
This skill provides knowledge about internal private libraries that MUST be used in place of standard external libraries. When refactoring or implementing code, you must check this skill to see if a private alternative exists.
